...
Message Center is under **Menu** in both games. It delivers messages inside the apps, including replies and read status. It sends no external emails or push notifications. The existing family-trust email/nickname entry is not proof of email ownership, so these messages are appropriate for the game group, not sensitive communications.
